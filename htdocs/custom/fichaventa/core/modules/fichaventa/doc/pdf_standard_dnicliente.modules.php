...
/**
 *  \file       core/modules/fichaventa/doc/pdf_standard.modules.php
 *  \ingroup    fichaventa
...
/**
 *	Class to manage PDF template standard_dnicliente
 */
class pdf_standard_dnicliente extends ModelePDFDniCliente
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_DNICLIENTE_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->fichaventa->dir_output.'/dnicliente')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->fichaventa->dir_output.'/dnicliente';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->fichaventa->dir_output.'/dnicliente/'.$objectref;
